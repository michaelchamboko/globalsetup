...
Copy-Item .agents\templates\tasks\module-plan-template.md build-pack\10-implementation-plan.md -Force
...
Write-Host "Build pack documents generated under build-pack/"
