...
cp .agents/templates/governance/source-manifest-template.json build-pack/source-manifest.json
cp .agents/templates/governance/requirements-template.json build-pack/requirements.json
cp .agents/templates/governance/grommet-approval-template.json build-pack/grommet-approval.json
...
cp .agents/templates/governance/source-manifest.schema.json build-pack/source-manifest.schema.json
cp .agents/templates/governance/requirements.schema.json build-pack/requirements.schema.json
cp .agents/templates/governance/grommet-approval.schema.json build-pack/grommet-approval.schema.json
