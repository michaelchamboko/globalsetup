...
3. **Surgical Changes**: Keep code diffs minimal and precise. Avoid unrelated refactors.
4. **Goal-Driven Execution**: Single-mindedly focus on completing acceptance criteria and passing all tests.
